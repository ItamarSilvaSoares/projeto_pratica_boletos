...
router.get('/search', async (req, res) => await userController.search(req, res));

router.get('/:username', async (req, res) => await userController.findOne(req, res));
...
router.put('/', validate.validateBodyUserUpdate, async (req, res) => await userController.update(req, res));
